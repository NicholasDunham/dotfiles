...
I don't need line numbers in the terminal.
...
Keeping this here for now, but I think I'm moving to Org-super-agenda (which is the block that follows and supersedes this one).
