...
1. Remove line numbers in presentation mode
2. Remove the status bar or modeline or whatever it is at the bottom of the screen
3. Either make the bullets line up with the text or remove them completely
4. Hide the cursor
