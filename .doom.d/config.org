...
I'm having trouble with the auth system for getting the secret key. Obviously I don't really understand how to use it. For now I'm setting an environment variable and reading that here, but going forward I want it to prompt me for a password the first time I run it, decrypt my =authsources.gpg= file, and use the key on subsequent runs. I know it's possible, I just need to understand how it works better.
...
(use-package! openai-api
  :config
  (setq openai-api-secret-key (getenv "OPENAI-KEY")
        openai-api-engine "text-davinci-002"
...
(map! :leader
      ...
      "i g" #'openai-api-complete-region)
#+end_src
